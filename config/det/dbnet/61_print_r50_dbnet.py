...
train_data = dict(
    dataset=dict(
        type='DetTextDataset',
        ann_file=r'/zzf/data/ocr_det_data/aiyunxiao/print_ocr_det/train/train_list.txt',
...
test_data = dict(
    dataset=dict(
        type='DetTextDataset',
        ann_file=r'/zzf/data/ocr_det_data/aiyunxiao/print_ocr_det/test/test_list.txt',
