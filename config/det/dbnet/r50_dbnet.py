...
train_data = dict(
    ...
    loader=dict(
        batch_size=4, # dist时，实际上的gpu应该是number*batch_size
...
lr_scheduler = dict(type='CosineWarmup', warm_up_epochs=3, epochs=1200)
# 优化器设置 默认SGD
...
options = dict(
    ...
    resume_from='work_dirs/r50_dbnet/best.pth',  # 用于程序以外中断，继续训练
    is_eval=True,
