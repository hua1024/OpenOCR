# coding=utf-8  
# @Time   : 2020/12/1 14:25
# @Auto   : zzf-jeff

'''
learn for :https://github.com/open-mmlab/mmcv/blob/master/mmcv/utils/registry.py
'''
...
def build_from_cfg(cfg, registry, default_args=None):
    ...
    if 'type' not in cfg:
        if default_args is None or 'type' not in default_args:
            raise KeyError(
                '`cfg` or `default_args` must contain the key "type", but got {}\n{}'.format(cfg, default_args))
